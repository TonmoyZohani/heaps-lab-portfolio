...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    offerings: [
      ...
      { title: "Landing Pages", description: "High-performing, conversion-optimised pages built around specific campaigns and target audiences." },
      { title: "Corporate Websites", description: "Professional, scalable, and fully managed web presence for established and growing businesses." },
      { title: "CMS-Powered Sites", description: "Full editorial control via Sanity, Contentful, or WordPress — no developer needed for updates." },
      { title: "Web Portals", description: "Authenticated user experiences featuring role-based dashboards and dynamic personalised content." },
  ...
  },
  {
    ...
    offerings: [
      { title: "Social Media Graphics", description: "Scroll-stopping visual assets carefully sized and technically optimised for every social platform." },
      { title: "Pitch Decks", description: "Investor and client pitch decks designed with narrative clarity and visual impact to land the meeting." },
      { title: "Print Collateral", description: "Print-ready brochures, flyers, banners, and signage that look sharp and professional in the real world." },
      { title: "Infographics", description: "Complex data, processes, and ideas made clear, engaging, and shareable through compelling visual storytelling." },
      { title: "Email Design", description: "Branded, mobile-responsive email templates and newsletters designed to drive opens and clicks." },
      { title: "Ad Creative", description: "High-converting digital ad creative assets built for Google Display, Meta, and LinkedIn campaigns." },
    ],
    process: [
  ...
  },
  {
    ...
    offerings: [
      { title: "Dashboard Design", description: "Complex, data-heavy interfaces made navigable, scannable, and immediately actionable for every user." },
      { title: "Onboarding Design", description: "Thoughtfully designed first-run experiences that activate users quickly and meaningfully reduce churn." },
      { title: "Design Systems", description: "Scalable, well-documented component libraries that keep product teams consistent and moving fast." },
      { title: "Enterprise UX", description: "Powerful enterprise tools that experienced users can master quickly and new users can learn without frustration." },
      { title: "Interaction Design", description: "Micro-interactions, transitions, and states that make products feel polished." },
      { title: "Usability Testing", description: "Structured usability testing sessions that clearly reveal where and why your product loses users." },
    ],
    process: [
